...
public abstract class SpringModelVisitor {
   ...
   */
  protected boolean visitBean(CommonSpringBean bean) { return true; }
  protected boolean visitProperty(SpringPropertyDefinition property) { return true; }
  protected boolean visitConstructorArg(ConstructorArg arg) { return true; }
  protected boolean visitValueHolder(SpringValueHolder valueHolder) { return true; }
  protected boolean visitMapEntry(SpringEntry entry) { return true; }
  protected boolean visitRef(SpringRef ref) { return true; }
  protected boolean visitIdref(Idref idref) { return true; }
