package com.intellij.spring.osgi.actions;
...
public class CreateSpringOsgiConfigAction extends CreateFileAction {

  public CreateSpringOsgiConfigAction() {
    super(SpringOsgiBundle.message("config.new.file"),
          SpringOsgiBundle.message("create.new.spring.configuration.file"),
  ...
  public static FileTemplate getConfigTemplate() {
    return FileTemplateManager.getInstance().getJ2eeTemplate("spring.osgi.config.xml");
  }
}
