...
public class GenerateDataAccessPatternsGroup extends DefaultActionGroup {
  ...
  public GenerateDataAccessPatternsGroup() {
    add(new GenerateSpringDomElementAction(new SpringBeanGenerateProvider(SpringBundle.message("spring.patterns.data.access.data.source"), "datasource"), Image.empty())) ;
    add(new GenerateSpringDomElementAction(new SpringBeanGenerateProvider(SpringBundle.message("spring.patterns.data.access.jndi.data.source"), "jndi-datasource"), Image.empty())) ;
