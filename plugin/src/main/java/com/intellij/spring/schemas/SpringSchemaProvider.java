...
public class SpringSchemaProvider extends XmlSchemaProvider implements DumbAware {
  ...
  @Nullable
  public XmlFile getSchema(@Nonnull @NonNls final String url, @Nullable Module module, @Nonnull final PsiFile baseFile) {
  ...
  @Nonnull
  public static Map<String,String> getHandlers(@Nonnull final Module module) {
    return computeHandlers(module);
  }

  @Nonnull
  private static CachedValueProvider.Result<Map<String,VirtualFile>> computeSchemas(@Nonnull final Module module) {
  ...
  @Nonnull
  private static Map<String, String> computeHandlers(@Nonnull final Module module) {
    final Project project = module.getProject();
