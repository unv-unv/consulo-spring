...
public class SpELVariableReferenceImpl extends SpELElementImpl implements PsiExpression, PsiReference {
    public SpELVariableReferenceImpl(ASTNode node) {
        super(node);
    }
    ...
    public @Nullable PsiElement resolve() {
        // TODO: variable resolution requires evaluation context
        return null;
    }

    @Override
    public @Nullable PsiType getType() {
        // TODO: variable type resolution requires evaluation context
        return null;
    }
